...
struct QuantizationViewModelTests {
    ...
    /// quantization), #24 (`pyramidkv`, eviction), and #25 (`qfilters`,
    ...
    /// guarantee issues #24 and #25 asked to confirm: the picker and detail
    /// banner must make the method's limitation clear *before* Start Job,
    /// not only as a server crash after.
    @Test(arguments: [
